  ...
  return (
    <>
     ...
     <div className='tasklist'>
            ...
            <div className="modal-body">
              {selectedTask && (
                <div>
                  ...
                  <button type="submit" className="btn mb-3" id="updatebtn" onClick={doneTask}>
      ...
      <input type="text" className="form-control" id="addtask" name="taskname" placeholder="Add a new task" ref={taskRef} />
      <button onClick={addTask} type="submit" className="btn mb-3" id="addbtn">
